...
const StockScreen = ({ navigation }) => {
  ...
  const [ingredients, setIngredients] = useState([
    { id: '1', name: 'Tomatoes', category: 'Vegetables', quantity: '10kg', lastUpdated: '2023-04-15' },
    { id: '2', name: 'Cheese', category: 'Dairy', quantity: '5kg', lastUpdated: '2023-04-15' },
    { id: '3', name: 'Flour', category: 'Baking', quantity: '20kg', lastUpdated: '2023-04-15' },
    { id: '4', name: 'Olive Oil', category: 'Oils', quantity: '3L', lastUpdated: '2023-04-15' },
  ]);
  ...
  // Category options
  const categories = ['Vegetables', 'Fruits', 'Dairy', 'Meat', 'Seafood', 'Baking', 'Oils', 'Spices', 'Other'];
  ...
  const addNewIngredient = () => {
    if (!newIngredient.name || !newIngredient.quantity) {
      Alert.alert("Missing Information", "Please provide at least a name and quantity for the ingredient");
      return;
    }
    ...
    const updatedIngredients = ingredients.map(item => {
      if (item.id === selectedIngredient.id) {
        return {
          ...item,
          name: newIngredient.name,
          category: newIngredient.category || item.category,
          quantity: newIngredient.quantity,
          lastUpdated: new Date().toISOString().split('T')[0],
        };
      }
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.addIngredientModalContent}>
            ...
            <View style={styles.formGroup}>
              ...
              >
                <Text>{newIngredient.category || 'Select category'}</Text>
                ...
                <View style={styles.dropdownMenu}>
                  {categories.map((category, index) => (
                    <TouchableOpacity
                      ...
                      onPress={() => {
                        setNewIngredient({...newIngredient, category: category});
